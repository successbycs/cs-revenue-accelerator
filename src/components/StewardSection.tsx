    ...
    <section id="cover-path" className="bg-dark-steward py-20 lg:py-28">
      <div className="section-container">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-on-dark/70">Interim fractional CS leadership that keeps your team performing, your customers retained, and your board confident while you hire the right permanent leader.
