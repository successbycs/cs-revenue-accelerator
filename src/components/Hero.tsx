        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-8 flex items-center gap-4 border-t border-border/50 pt-6">
              ...
              <div className="text-center">
                <p className="font-heading text-xl font-bold text-accent-builder">+18%</p>
                <p className="font-mono text-[10px] uppercase tracking-wider text-muted-foreground">Avg NRR Lift</p>
              </div>
              <div className="h-8 w-px bg-border" />
              <div className="text-center">
                <p className="font-heading text-xl font-bold text-accent-steward">–32%</p>
                <p className="font-mono text-[10px] uppercase tracking-wider text-muted-foreground">Churn Reduced</p>
              </div>
              <div className="h-8 w-px bg-border" />
              <div className="text-center">
